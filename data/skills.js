export const SKILLS = [
  {
    ...
    more: 'What it looks like when it\'s missing: a kid who\'s jumpy, who reads your face before they say good morning, who manages your moods instead of their own. The work that\'s yours is to notice your own thermostat first — you can\'t lower the temperature in a room you\'re heating up. Catch the storm before it reaches the door, not after.',
  ...
  },
  {
    ...
    summary: 'Tone, listening, disagreement, and repair — the skills that hold every relationship.',
